...
<head>
    ...
    <title>Kategori - Warranty Management</title>
    ...
    <main class="content">
        ...
        <div class="table-card">
            ...
            <div class="section-header">
                ...
                <div>
                    <h2>Data Kategori</h2>
                    <p>Daftar seluruh kategori produk.</p>
                </div>

                <a href="kategori_tambah.php" class="btn-primary">
                    + Tambah Kategori
                </a>
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="kategori_edit.php?id=<?= $row['id']; ?>" class="action-link">
                                Edit
                            </a>
